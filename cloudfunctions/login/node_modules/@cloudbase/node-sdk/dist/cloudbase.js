...
class CloudBase {
     ...
     * @param params
     * notifyId: 通知策略Id
     * notifyUserNames: 待通知的用户名
     * data: 通知策略下的模板变量对应值，需要JSON序列化
     * detailUrl: 点击消息卡片打开的链接
     * @returns
     */
    async pushNotifyMsg(params, opts) {
        return await (0, functions_1.callFunction)(this, {
            ...
            data: {
                ...
                params: {
                    ...
                    data: {
                        ...
                        NotifyUsers: params.notifyUserNames,
